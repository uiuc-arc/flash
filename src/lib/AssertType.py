...
class AssertType(Enum):
    ...
    def get_assert_type(funcname:str):
        ...
        elif funcname == 'assert_almost_equal':
    ...
    def is_unittest_assert(assert_spec):
        return assert_spec.assert_type in [AssertType.ASSERTGREATEREQUAL, AssertType.ASSERTGREATER,
                                           ...
                                           AssertType.ASSERTLESS, AssertType.ASSERTLESSEQUAL]

    @staticmethod
    def is_numpy_assert(assert_spec):
        return assert_spec.assert_type in [AssertType.ASSERT_ALLCLOSE, AssertType.ASSERT_ALMOST_EQUAL,
    ...
    def is_tolerance_assert(assert_spec):
        ...
        return s in [AssertType.ASSERT_ALMOST_EQUAL, AssertType.ASSERT_APPROX_EQUAL, AssertType.ASSERT_ARRAY_ALMOST_EQUAL,
